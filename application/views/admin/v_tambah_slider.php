                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <form action="<?php echo base_url() . 'admin/data_website/add_slider' ?>" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label>Title Slider</label>
                                                    <textarea id="ckeditor" name="a"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>Gambar</label>
