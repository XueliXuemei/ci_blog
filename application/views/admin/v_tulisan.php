            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo base_url() . 'admin/siswa' ?>"><i class="fa fa-users"></i> Data
        ...
        <div class="modal fade" id="ModalHapus<?php echo $tulisan_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'admin/tulisan/hapus' ?>" method="post" enctype="multipart/form-data">
