        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#">Identias Website</a></li>
                </ol>
            </section>
                                    ...
                                    <table class="table table-striped" style="font-size:13px;">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data->result_array() as $i) :
                                                $no++;
                                                $id_identitas = $i['id_identitas'];
                                                $nama_website = $i['nama_website'];
                                                $alamat_website = $i['alamat_website'];
                                                $meta_deskripsi = $i['meta_deskripsi'];
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <?php
                                                    if (!empty($gambar)) { ?>
                                                        <td style="text-align:center;"><img src="<?php echo base_url() . '/theme/images/icon/' . $gambar; ?>" style="width:90px;"></td>
                                                    <?php } else { ?>
                                                        <td style="text-align:center;"><b>Tidak ada gambar</b></td>
                                                    <?php } ?>
                                                    <td><?= $nama_website ?> </td>
                                                    <td><?= $alamat_website ?> </td>
                                                    <td><?= $meta_deskripsi ?> </td>
                                                    <td><?= $meta_keyword ?> </td>
                                                    <td style="text-align:center;">
                                                        <a class="btn btn-warning btn-xs" href="<?php echo base_url() . 'admin/identitas/edit_indentitas/' . $id_identitas; ?>"><span class="fa fa-pencil"> Edit Identitas</span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
