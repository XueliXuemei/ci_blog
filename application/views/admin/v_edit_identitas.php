            ...
            <section class="content">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title">Form Tambah Halaman Statis</h3>
                    </div>
                    <div class="box-body">
                        <?php
                        $b = $data->row_array();
                        ?>
                        <form action="<?php echo base_url() . 'admin/identitas/identitas_edit' ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Nama Website</label>
                                        <input type="hidden" name="kode" value="<?php echo $b['id_identitas']; ?>">
                                        <input type="text" name="xnamaweb" class="form-control" value="<?php echo $b['nama_website']; ?>" />
                                    </div>
                                    <div class="form-group">
                                        <label>Alamat Website</label>
                                        <input type="text" name="xalamatweb" class="form-control" value="<?php echo $b['alamat_website']; ?>" />
                                    </div>
                                    <div class="form-group">
                                        <label>Meta deskripsi</label>
                                        <input type="text" name="xmeta_deskripsi" class="form-control" value="<?php echo $b['meta_deskripsi']; ?>" />
                                    </div>
                                    <div class="form-group">
                                        <label>Meta keyword</label>
                                        <input type="text" name="xmeta_keyword" class="form-control" value="<?php echo $b['meta_keyword']; ?>" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-flat"><span class="fa fa-pencil"></span>Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </form>
